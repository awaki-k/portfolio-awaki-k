...
module mlp_tb;
    ...
    parameter integer TRUE_LABEL = 7;
    ...
    wire                        rq_fc1_valid_dbg;
    wire                        rq_fc1_en_dbg;
    wire [X1_WIDTH*PE_NUM-1:0]   rq_fc1_out_dbg;
    wire                        rq_fc2_en_dbg;
    // wire                        xw1_rd_en_dbg;
    ...
    mlp #(
        ...
        , .rq_fc1_valid_dbg       (rq_fc1_valid_dbg)
        , .rq_fc1_en_dbg      (rq_fc1_en_dbg)
        , .rq_fc1_out_dbg     (rq_fc1_out_dbg)
        , .rq_fc2_en_dbg      (rq_fc2_en_dbg)
